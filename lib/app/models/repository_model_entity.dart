...
class RepositoryModelEntity with JsonConvert<RepositoryModelEntity> {
	@JSONField(name: "total_count")
	int? totalCount;
	@JSONField(name: "incomplete_results")
	bool? incompleteResults;
	List<RepositoryModelItems>? items;
}

class RepositoryModelItems with JsonConvert<RepositoryModelItems> {
	int? id;
...
class RepositoryModelItemsOwner with JsonConvert<RepositoryModelItemsOwner> {
	String? login;
	int? id;
	@JSONField(name: "node_id")
	String? nodeId;
...
class RepositoryModelItemsLicense with JsonConvert<RepositoryModelItemsLicense> {
	String? key;
	String? name;
