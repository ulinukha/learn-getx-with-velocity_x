...
repositoryModelEntityFromJson(RepositoryModelEntity data, Map<String, dynamic> json) {
	...
	if (json['items'] != null) {
		data.items = (json['items'] as List).map((v) => RepositoryModelItems().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> repositoryModelEntityToJson(RepositoryModelEntity entity) {
...
repositoryModelItemsFromJson(RepositoryModelItems data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['owner'] != null) {
		data.owner = RepositoryModelItemsOwner().fromJson(json['owner']);
	}
	...
	if (json['license'] != null) {
		data.license = RepositoryModelItemsLicense().fromJson(json['license']);
	}
	if (json['allow_forking'] != null) {
		data.allowForking = json['allow_forking'];
	}
	if (json['is_template'] != null) {
		data.isTemplate = json['is_template'];
	}
	if (json['topics'] != null) {
		data.topics = (json['topics'] as List).map((v) => v.toString()).toList().cast<String>();
	}
...
Map<String, dynamic> repositoryModelItemsToJson(RepositoryModelItems entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
repositoryModelItemsOwnerFromJson(RepositoryModelItemsOwner data, Map<String, dynamic> json) {
	if (json['login'] != null) {
...
Map<String, dynamic> repositoryModelItemsOwnerToJson(RepositoryModelItemsOwner entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
repositoryModelItemsLicenseFromJson(RepositoryModelItemsLicense data, Map<String, dynamic> json) {
	if (json['key'] != null) {
...
Map<String, dynamic> repositoryModelItemsLicenseToJson(RepositoryModelItemsLicense entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['key'] = entity.key;
	data['name'] = entity.name;
